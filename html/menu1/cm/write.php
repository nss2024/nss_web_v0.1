...
<tr><th style="text-align:justify;font-size:20px;padding-top:30px;">이미지 :
<input type="file" name="img" style="border:1px dashed black;"></th><br>
<tr>
<th style="text-align:justify;font-size:20px;padding-top:30px;">첨부파일 : 
<input type="file" name="file" style="border:1px dashed black;"></th><br>
